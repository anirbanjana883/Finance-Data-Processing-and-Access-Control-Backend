...
| **ANALYST** | `ga1@example.com` | `ganalyst1@123` | **Standard Access.** Can view and create financial transactions and view the dashboard. Cannot manage users or organization settings. |
| **VIEWER** | `gv1@example.com` | `gviewer@123` | **Restricted Access.** Read-only access to the aggregated Dashboard summary. Strictly blocked from viewing or editing raw ledger transactions. |
